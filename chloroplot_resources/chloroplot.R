...
# This is a simple wrapper around Chloroplot's script for IR detection.
# To make it a single script, contenct of original file for IR detection (detect_ir.R) is inserted here.
#
# Note: few lines of code are removed. They are commented with "COMMENTED:".
#
# Output is of type:
#
# $ir_table
...
#
# Dependencies:
#  - BiocManager: Biostrings, genbankr
#    install.packages("BiocManager")
#    # For appropriate version check BiocManager releases!!!
...
# -----------------------------------------------------------------------------
# File detect_ir.R from Chloroplost project:
# https://github.com/shuyuzheng/Chloroplot
# Accesed 14.7.2021.
# Commit: 933cf09
#
# Project's file is: R/detect_ir.R
# File's latest commit: 1b637a9
